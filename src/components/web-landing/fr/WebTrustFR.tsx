...
const WebTrustFR = () => {
  const trustPoints = [
    { icon: CreditCard, text: "Paiement traité exclusivement par Stripe (leader mondial des paiements en ligne)" },
    ...
    { icon: Users, text: "Entreprise identifiable, joignable à tout moment" },
    { icon: ClipboardCheck, text: "Processus clair : acompte pour démarrer, solde à la livraison" },
  ];
