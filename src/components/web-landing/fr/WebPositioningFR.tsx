import { Zap, Shield, Code, Sparkles, Palette, FileText } from "lucide-react";

const WebPositioningFR = () => {
  const highlights = [
    { icon: Zap, title: "Livraison 72h", description: "Sites livrés en quelques jours", color: "from-yellow-500 to-orange-500" },
    { icon: Palette, title: "Design UX/UI", description: "Interfaces modernes et performantes", color: "from-purple-500 to-pink-500" },
    { icon: FileText, title: "Copywriting", description: "Textes optimisés conversion", color: "from-blue-500 to-cyan-500" },
    { icon: Code, title: "Code Source Fourni", description: "100% propriétaire", color: "from-emerald-500 to-teal-500" },
  ];
  ...
  const services = [
    ...
    "Intégration CRM & automatisations",
        ...
        <div className="max-w-5xl mx-auto">
          <header className="text-center mb-8">
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground">
              Sites web professionnels, prêts à générer du revenu
            </h2>
          </header>
          ...
          <article className="bg-gradient-to-br from-card via-card to-muted/30 rounded-3xl p-6 md:p-10 mb-12 border border-border shadow-xl relative overflow-hidden">
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed relative z-10">
              ...
              spécialisée dans la création de sites web à haute performance commerciale.
            </p>
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed mt-4 relative z-10">
              Nous livrons des <span className="text-primary font-semibold">sites web clé en main en moins de 72 heures</span>, 
              avec design UX/UI, copywriting, SEO, CRM, automatisations et analytics intégrés.
            </p>
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed mt-6 relative z-10">
              <strong className="text-foreground">Vous êtes 100% propriétaire du code source</strong> et nous vous le fournissons à la livraison. 
              Pas de dépendance, pas d'abonnement caché.
            </p>
          </article>
...
export default WebPositioningFR;
