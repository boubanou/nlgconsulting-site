  ...
  const testimonials = [
    {
      ...
      rating: 5,
      highlight: "Très rapide",
      avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop&crop=face",
    },
    {
      name: "Thomas R.",
      role: "Dirigeant PME",
      content: "Une équipe professionnelle et réactive. Le site était en ligne en moins de 48 heures.",
      rating: 5,
    ...
    },
    {
      ...
      content: "Rarement vu une telle rapidité avec ce niveau de qualité. Code source fourni, tout est clair.",
      rating: 5,
    ...
    },
    {
      name: "Pierre D.",
      role: "Entrepreneur",
      content: "Processus transparent du début à la fin. Le site correspond exactement à mes attentes.",
      rating: 5,
      highlight: "Processus transparent",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <header className="text-center mb-12">
          ...
          <p className="text-base md:text-lg text-muted-foreground">
            Ils nous ont fait confiance pour la création de leur site web professionnel
          </p>
        </header>
        ...
        <div className="flex items-center justify-center gap-2 mt-10 text-muted-foreground">
          ...
          <span className="text-sm ml-2">50+ clients satisfaits</span>
        </div>
      </div>
    </section>
  );
...
export default WebTestimonialsFR;
